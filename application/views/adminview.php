...
<div id="test" data-status='opened'>
    ...
    <div class="list-group">
      ...
      <a class="list-group-item1 active" href="<?php echo base_url();?>Admin/ShowPointHistory">Point History</a>
      <a class="list-group-item1" href="<?php echo base_url();?>Admin/logout">Logout</a>

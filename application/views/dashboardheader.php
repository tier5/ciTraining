<head>
    ...
    <script href="<?php echo base_url().'assets/js/jquery.fittext.js';?>" ></script>
    <script href="<?php echo base_url().'assets/js/wow.min.js';?>" ></script>

    <!-- Custom Theme JavaScript -->
    <script href="<?php echo base_url().'assets/js/creative.js';?>" ></script>

  <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.0/jquery.min.js"></script>
  <script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url().'assets/js/dashboardbuttons.js';?>"></script>
